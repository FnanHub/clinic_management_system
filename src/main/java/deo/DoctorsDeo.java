...
public class DoctorsDeo {
    ...
    static {
        ...
        doctors.put("1006",new Doctor("1006","Melat", "Gebreyohannes", LocalDate.of(1994, 03, 6), address, "merih@mum.edu", "862-704-4056", "2"));
        doctors.put("1007",new Doctor("1007","Merry7", "Gebre", LocalDate.of(1990, 03, 7), address, "meliabe@mum.edu", "862-704-4056", "2"));
        doctors.put("1008",new Doctor("1008","Maron", "Donald", LocalDate.of(1990, 03, 8), address, "merrymax@mum.edu", "862-704-4056", "2"));
        ...
        doctors.put("1012",new Doctor("1012","Jhon", "Helvet", LocalDate.of(1990, 03, 23), address, "meki@mum.edu", "234-862-4056", "3"));
        doctors.put("1013",new Doctor("1013","Jerry", "Geabril", LocalDate.of(1990, 03, 23), address, "rih@mum.edu", "829-704-4056", "3"));
        ...
        doctors.put("1017",new Doctor("1017","Makda", "Jospeh", LocalDate.of(1990, 03, 23), address, "abemel@mum.edu", "754-704-4056", "4"));

        doctors.put("1018",new Doctor("1018","Henok", "Bill", LocalDate.of(1990, 03, 23), address, "sndkthe288@mum.edu", "262-704-5674", "4"));
        doctors.put("1019",new Doctor("1019","Leno", "Bilard", LocalDate.of(1990, 03, 23), address, "how45@mum.edu", "405-704-4056", "4"));
        ...
        doctors.put("1027",new Doctor("1027","Mavin", "Clinton", LocalDate.of(1990, 03, 23), address, "gerry@mum.edu", "712-704-4056", "5"));
        doctors.put("1028",new Doctor("1028","Hawk", "habrion", LocalDate.of(1990, 03, 23), address, "merih@mum.edu", "866-704-4056", "5"));
        doctors.put("1029",new Doctor("1029","Hilary", "Gist", LocalDate.of(1990, 03, 23), address, "rich12@mum.edu", "918-862-4056", "5"));


        doctors.put("1020",new Doctor("1020","Bernand", "Gerry", LocalDate.of(1990, 03, 23), address, "hona123@mum.edu", "862-704-4056", "4"));
        doctors.put("1021",new Doctor("1021","Angelo", "yohannes", LocalDate.of(1990, 03, 23), address, "erigirl@mum.edu", "4056-862-5674", "4"));
        doctors.put("1022",new Doctor("1022","Tom", "hannes", LocalDate.of(1990, 03, 23), address, "Tiggirl@mum.edu", "405-704-4056", "4"));
    }
